...
enum HOST_CMD {
    ...
    HOST_CMD_SET_FIRST_APTS,
    HOST_CMD_GET_FIRST_APTS,
    HOST_CMD_SET_FIRST_VPTS,
    HOST_CMD_GET_FIRST_VPTS,
    HOST_CMD_SET_DROP_DONE,
    HOST_CMD_GET_DROP_DONE,
    ...
    HOST_CMD_GET_DISCONTINUE_FLAG = 0x300,
