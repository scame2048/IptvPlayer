...
package dai.android.video.iptv.client;
...
public class RtspClient {
    ...
    private Runnable startConnection = new Runnable() {
        ...
        public void run() {
            ...
            Logger.d(TAG, "Start to connect the server...");
    ...
    private void sendRequestOptions() throws IOException {
        ...
        Logger.d(TAG, request.substring(0, request.indexOf("\r\n")));
    ...
    private void sendRequestSetup() throws IOException {
        ...
        Logger.d(TAG, "the session is " + mSession);
        ...
        if (matcher.find()) {
            Logger.d(TAG, "The client port is:" + matcher.group(1) + " ,the server prot is:" + (isTCPtranslate ? "null" : matcher.group(2)) + "...");
            ...
            if (isTCPtranslate) {
                Logger.d(TAG, "Without get the transport port infom, use the rtsp tcp socket!");
    ...
    static class Response {
        ...
        public static Response parseResponse(BufferedReader input) throws IOException {
            ...
            Logger.d(TAG, "The response state is: " + response.state);
