package dai.android.video.iptv.client.video;
...
public class H264Stream extends VideoStream {
        ...
        public void run() {
            ...
            while (!Thread.interrupted() && !isStop) {
                try {
                    ...
                    Logger.e(tag, "Wait the buffer come..");
                }
            }
            bufferQueue.clear();
            mMeidaCodec.stop();
    ...
    private void decodeSPS() {
        ...
        Logger.e(tag, "The picWidth = " + picWidth + " ,the picHeight = " + picHeight);
    }
    ...
    public void setSurfaceView(SurfaceView s) {
        ...
        if (Build.VERSION.SDK_INT > 15) {
            ...
            Logger.e(tag, "The Platform not support the hardware decode H264!");
        }
    }
    ...
    protected void decodeH264Stream() {
        try {
            ...
            Logger.e(tag, "The buffer queue is full , wait for the place..");
        }
    }
}